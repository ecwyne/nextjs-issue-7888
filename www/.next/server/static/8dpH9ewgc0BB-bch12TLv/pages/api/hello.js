...
var external_faunadb_ = __webpack_require__("3jov");
...
var client = new external_faunadb_["Client"]({
  secret: 'fnADR7Y8Y4ACABs84WzroG6sqF7iBXlCCsn2mGeW'
});
var server = new external_apollo_server_micro_["ApolloServer"]({
  typeDefs: Object(external_apollo_server_micro_["gql"])(_templateObject()),
  resolvers: {
    Query: {
      loggedIn: function loggedIn() {
        return client.query(external_faunadb_["query"].HasIdentity());
      }
    }
  }
});
...
/* harmony default export */ var hello = __webpack_exports__["default"] = (server.createHandler({
  path: '/api/hello'
}));
